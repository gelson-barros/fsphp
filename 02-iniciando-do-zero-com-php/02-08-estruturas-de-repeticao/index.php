...
for ($c=1; $c < 10; $c++) {
	if ($c % 2 == 1) {
		continue;//continua o ciclo ou seja nao executa instrucoes abaixo
	}

	if ($c >= 10) {
		break;//termina o ciclo ou seja para todas instrucoes ate aqui
	}
...
/*foreach serve para abrir conteudo array ou objecto multidimensional */
$array = [];
for ($ar = 0 ; $ar <= 2; $ar++){
	$array[] = $ar;
}
